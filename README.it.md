...
| | |
|---|---|
| **Sorgente** | Il telefono che comanda. Scegli tu l'app da allargare, e si apre su uno schermo più grande di quello che hai in mano. |
| **Display secondario** | Il telefono che completa lo schermo. Mostra la sua parte, e su quella parte tocchi, trascini e scrivi come sull'originale. |
| **Il collegamento** | Wi-Fi Direct, da telefono a telefono. Nessuna rete Wi-Fi in comune, nessun router, nessun cavo. |
...
La [**Roadmap**](ROADMAP.it.md) elenca quello che c'è già, quello che
...
*Disponibile anche in [inglese](ROADMAP.md).*
...
```
README.md         lo stesso file, in inglese
...
ROADMAP.md        fatto, in arrivo, e cosa non è in programma (in inglese)
ROADMAP.it.md     la stessa roadmap in italiano
...
**ScreenSpan** · [Laerte Olmelli](https://github.com/Laerte1989) · [laerte.developer@gmail.com](mailto:laerte.developer@gmail.com)
